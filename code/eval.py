...
def get_args():
    ...
    parser.add_argument('--model', type=str,
                        default='res50', help='Model against GAN is trained: incv3, res50')
    parser.add_argument('--generator_weight_path', type=str,
                        default='/root/autodl-tmp/TSAA_Capstone_Project/code/temp/res50_-1_20.pth',
                        help='Path of generator weight')
    parser.add_argument('--eps', type=int,
                        default=20, help='Perturbation Budget')
    # target model
    parser.add_argument('--target_model', type=str,
                        default='res50', help='Model under attack : vgg16, incv3, res50, dense161')
    parser.add_argument('--target_model_weight', type=str,
                        default='/root/autodl-tmp/TSAA_Capstone_Project/code/pytorch_cifar/checkpoint/res50/20230406_ckpt.pth',
